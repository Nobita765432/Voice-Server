...
# ==== AUDIO HANDLING ONLY FOR CLIENTS ====
IS_SERVER = SERVER_IP == socket.gethostbyname(socket.gethostname())

if not IS_SERVER:
    # Only run audio code for clients
    ...
    print("Server running... Waiting for clients to connect.")
